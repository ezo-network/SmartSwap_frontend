...
$(document).ready(function (e) {
	...
	$('ul.tabs-n li').click(function () {
		var tab_id = $(this).attr('data-tab');
		$('ul.tabs-n li').removeClass('current-n');
		$('.tab-content-n').removeClass('current-n');
		$(this).addClass('current-n');
		$("#" + tab_id).addClass('current-n');
	});
	// custom select

	let test = $('.select-item').each(function () {
		var getId = $(this).attr('id');
		$('#' + getId).IconSelectBox(true);
	});
})